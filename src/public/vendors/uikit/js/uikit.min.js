/*! UIkit 3.3.3 | http://www.getuikit.com | (c) 2014 - 2019 YOOtheme | MIT License */ ! function(t, e) {
    ...
    function V(t) {
        return C(t) ? [t] : M(t) ? g.slice.call(t) : k(t) ? t.map(W).filter(Boolean) : _(t) ? t.toArray() : []
    }
    ...
    function St(t, s, e) {
        ...
        var a;
        At(t = t.replace(Et, "$1 *")) && (a = [], t = t.match(_t).map(function(t) {
            return t.replace(/,$/, "").trim()
        }).map(function(t, e) {
            var i = s;
            if ("!" === t[0]) {
                var n = t.substr(1).trim().split(" ");
                i = Dt(Pt(s), n[0]), t = n.slice(1).join(" ").trim()
            }
            if ("-" === t[0]) {
    ...
    function ge(t, e, i, n) {
        ...
        var r = (e = V(e)).length;
        return t = B(t) ? F(t) : "next" === t ? i + 1 : "previous" === t ? i - 1 : pe(e, t), n ? tt(t, 0, r - 1) : (t %= r) < 0 ? t + r : t
    }
    ...
    function ve(t, e) {
        return t = Ce(t), H(e) ? t.innerHTML : we(t.hasChildNodes() ? me(t) : t, e)
    }

    function we(e, t) {
        return e = Ce(e), ye(t, function(t) {
    ...
    function Ue(t) {
        ...
        if (!(t in Ye)) {
            ...
            ze(i, "uk-" + t), Ye[t] = qe(i, "content", ":before").replace(/^["'](.*)["']$/, "$1"), ke(i)
        }
        return Ye[t]
    }
    var Xe = {};
    ...
    function oi(t, e, c, l, d, i, n, r) {
        ...
        var p = ai(t),
            g = ai(e),
            m = g;
        if (pi(m, c, p, -1), pi(m, l, g, 1), d = mi(d, p.width, p.height), i = mi(i, g.width, g.height), d.x += i.x, d.y += i.y, m.left += d.x, m.top += d.y, n) {
            var o = [ai(R(t))];
            r && o.unshift(ai(r)), J(ri, function(t, s) {
                ...
                !0 !== n && !b(n, a) || o.some(function(n) {
                    ...
                    function o(e, t) {
                        var i = m[h] + e + t - 2 * d[a];
                        if (i >= n[h] && i + p[s] <= n[u]) return m[h] = i, ["element", "target"].forEach(function(t) {
    ...
    function ai(t) {
        ...
        Wt(t) || "none" !== Ve(t, "display") || (e = ot(t, "style"), i = ot(t, "hidden"), ot(t, {
    ...
    function mi(t, e, i) {
        var n = (t || "").split(" "),
            ...
            o = n[1];
        return {
            x: r ? j(r) * (c(r, "%") ? e / 100 : 1) : 0,
            y: o ? j(o) * (c(o, "%") ? i / 100 : 1) : 0
        }
    }
    ...
    function wi(t, e, i) {
        return void 0 === e && (e = "width"), void 0 === i && (i = window), B(t) ? +t : c(t, "vh") ? bi(ci(R(i)), t) : c(t, "vw") ? bi(li(R(i)), t) : c(t, "%") ? bi(ai(i)[e], t) : j(t)
    }
    ...
    function Ci(e, i, n) {
        var r = {};
        if ($(i) && (i = i.options), i.extends && (e = Ci(e, i.extends, n)), i.mixins)
    ...
    Ei.events = Ei.created = Ei.beforeConnect = Ei.connected = Ei.beforeDisconnect = Ei.disconnected = Ei.destroy = _i, Ei.args = function(t, e) {
        return !1 !== e && _i(e || t)
    ...
    function Pi(t, e, i) {
        if (void 0 === e && (e = 0), void 0 === i && (i = 0), !Wt(t)) return !1;
                    ...
                    i = i.then(function() {
                        return new se(function(i) {
                            var n = c[e],
                                ...
                                s = Date.now(),
                                a = function() {
                                    var t, e = (t = tt((Date.now() - s) / h), .5 * (1 - Math.cos(Math.PI * t)));
                                    Bi(n, r + o * e), 1 != e ? requestAnimationFrame(a) : i()
                                };
                            a()
                        })
                    })
                }, r = 0; r < c.length - 1; r++) n(r);
            return i
        }
    }
    ...
    function on(e, i, n) {
        ...
        }) : !r || u && !u.call(e) || e._events.push(Ut(r, t, h ? D(h) ? h : h.call(e) : null, D(o) ? e[o] : o.bind(e), {
            passive: a,
            capture: s,
            self: c
        }))
    ...
    qi.util = Object.freeze({
            ...
            scrollParents: Li,
            getViewport: Fi
        }), qi.data = "__uikit__", qi.prefix = "uk-", qi.options = {}, qi.version = "3.3.3", Xi = (Yi = qi).data, Yi.use = function(t) {
            ...
            this._connected || (this._data = {}, this._computeds = {}, this._initProps(), this._callHook("beforeConnect"), this._connected = !0, this._initWatches(), this._initEvents(), this._initObserver(), this._callHook("connected"), this._callUpdate())
            ...
            (t = t || {}).data = function(t, e) {
                ...
                reads: {},
                writes: {}
            }, this._events = [], this._uid = Ji++, this._initData(), this._initMethods(), this._initComputeds(), this._callHook("created"), t.el && this.$mount(t.el)
            ...
            for (var i in e) {
                var n = e[i];
                delete e[i], t[i].watch && !U(n, this[i]) && t[i].watch.call(this, this[i], n)
            }
        ...
        function(n) {
            ...
            n.prototype.$mount = function(t) {
                ...
                t[r] || (t[r] = {}), t[r][e] || ((t[r][e] = this).$el = this.$options.el = this.$options.el || t, Yt(t, document) && this._callConnected())
            ...
            methods: {
                toggleElement: function(u, c, l) {
                    ...
                    return new se(function(t) {
                        ...
                        var i;
                        if (d.queued && H(l) && H(c) && d.hasAnimation && !(u.length < 2)) {
                ...
                _toggleElement: function(t, e, i) {
                    ...
                    var r, o, s, a, h, u, c, l, d, f, p, g, m = ($(i) ? i : !1 !== i && this.hasAnimation ? this.hasTransition ? (c = (u = this).isToggled, l = u.duration, d = u.initProps, f = u.hideProps, p = u.transition, g = u._toggle, function(t, e) {
                        var i = Ze.inProgress(t),
                            n = t.hasChildNodes ? j(Ve(t.firstElementChild, "marginTop")) + j(Ve(t.lastElementChild, "marginBottom")) : 0,
                            r = Wt(t) ? ci(t) + (i ? 0 : n) : 0;
                        Ze.cancel(t), c(t) || g(t, !0), ci(t, ""), xi.flush();
                        var o = ci(t) + (i ? 0 : n);
                        return ci(t, r), (e ? Ze.start(t, G({}, d, {
                            overflow: "hidden",
                            height: o
                        }), Math.round(l * (1 - r / o)), p) : Ze.start(t, f, Math.round(l * (r / o)), p).then(function() {
                            return g(t, !1)
                        })).then(function() {
                            return Ve(t, d)
                        })
                    }) : (o = (r = this).animation, s = r.duration, a = r.origin, h = r._toggle, function(t, e) {
                        return ni.cancel(t), e ? (h(t, !0), ni.in(t, o[0], s, a)) : ni.out(t, o[1] || o[0], s, a).then(function() {
                            return h(t, !1)
                        })
                    }) : this._toggle)(t, e);
                    ...
                    return m ? m.then(v) : se.resolve(v())
                },
                ...
                toggle: function(r, o) {
                    ...
                    (r = this.items[t]) && [r].concat(!this.multiple && !b(a, r) && a || []).forEach(function(e) {
                        ...
                        if (i || !t || s.collapsible || !(a.length < 2)) {
                            ...
                            e._wrapper || (e._wrapper = $e(n, "<div>"), ot(e._wrapper, "hidden", i ? "" : null)), s._toggle(n, !0), s.toggleElement(e._wrapper, i, o).then(function() {
                                if (Oe(e, s.clsOpen) === i) {
                                    if (i) {
    ...
    var pn, gn = {
            ...
            methods: {
                positionAt: function(t, e, i) {
                    var n;
                    Pe(t, this.clsPos + "-(top|bottom|left|right)(-[a-z]+)?"), Ve(t, {
                        top: "",
                        left: ""
                    });
                    var r = this.offset,
        ...
        mn = {
            ...
            events: [{
                ...
                handler: function() {
                    var n = this;
                    (pn = this).tracker.init(), Kt(this.$el, "updatearia");
                ...
                handler: function(t) {
                    var e = t.target;
                    this.$el === e ? (pn = this.isActive() ? null : pn, Kt(this.$el, "updatearia"), this.tracker.cancel()) : pn = null === pn && Yt(e, this.$el) && this.isToggled() ? this : pn
                }
            }, {
                name: "updatearia",
                self: !0,
            ...
            methods: {
                show: function(t, e) {
                    ...
                    if (void 0 === t && (t = this.toggle), void 0 === e && (e = !0), this.isToggled() && t && this.toggle && t.$el !== this.toggle.$el && this.hide(!1), this.toggle = t, this.clearTimers(), !this.isActive()) {
                        if (pn) {
                            ...
                            for (; pn && !Yt(this.$el, pn.$el);) pn.hide(!1)
                        }
                ...
                hide: function(t) {
                    ...
                    var n, r;
                    this.clearTimers(), this.isDelaying = (n = this.$el, r = [], _e(n, function(t) {
                ...
                position: function() {
                    Pe(this.$el, this.clsDrop + "-(stack|boundary)"), Ve(this.$el, {
                        top: "",
                        left: "",
                        display: "block"
        ...
        bn = {
            ...
            update: function() {
                var t = this.target,
                    e = this.input;
                if (t) {
                    var i, n = Rt(t) ? "value" : "textContent",
                        r = t[n],
        ...
        update: [{
            ...
            read: function(t) {
                ...
                if (this.masonry && this.length) {
                    ...
                    }, [])) + (e = this.$el, i = this.margin, n = Ot(e), j((o = n.filter(function(t) {
                        return Oe(t, i)
    ...
    var _n = {
        ...
        update: {
            read: function(t) {
                ...
                if (this.expand) {
                    if (this.$el.dataset.heightExpand = "", Ce("[data-height-expand]") !== this.$el) return !1;
                    ...
                    }!0 === this.offsetBottom ? i += " - " + Cn(this.$el.nextElementSibling) + "px" : B(this.offsetBottom) ? i += " - " + this.offsetBottom + "vh" : this.offsetBottom && c(this.offsetBottom, "px") ? i += " - " + j(this.offsetBottom) + "px" : D(this.offsetBottom) && (i += " - " + Cn(xt(this.offsetBottom, this.$el)) + "px"), i += (n ? " - " + n + "px" : "") + ")"
                }
                return {
                    minHeight: i,
                    prev: e
                    ...
                    return function(i) {
                        ...
                        return function(t, e) {
                            e && b(t, "<symbol") && (t = function(t, e) {
                                if (!Dn[t]) {
                                    var i;
                                    for (Dn[t] = {}; i = zn.exec(t);) Dn[t][i[3]] = '<svg xmlns="http://www.w3.org/2000/svg"' + i[1] + "svg>";
                                    zn.lastIndex = 0
                                }
                                return Dn[t][e]
                            }(t, e) || t);
        ...
        methods: {
            load: function(t) {
                ...
                t.some(function(t) {
                    ...
                    return Yn(e.$el, Qn(t), t.srcset, t.sizes), tr[e.cacheKey] = Qn(t), t
    ...
    function Yn(t, e, i, n) {
        if (Zn(t)) n && (t.sizes = n), i && (t.srcset = i), e && (t.src = e);
            ...
            !b(t.style.backgroundImage, e) && (Ve(t, "backgroundImage", "url(" + Lt(e) + ")"), Kt(t, Jt("load", !1)))
        }
    }
    ...
    var ir = {
        ...
        computed: {
            matchMedia: function() {
                var t = function(t) {
                    if (D(t)) {
                        if ("@" === t[0]) t = j(Ue("breakpoint-" + t.substr(1)));
    ...
    var nr = {
        ...
        sr = {
            ...
            events: [{
                ...
                handler: function() {
                    var r = this;
                    li(window) - li(document) && this.overlay && Ve(document.body, "overflowY", "scroll"), ze(document.documentElement, this.clsPage), this.bgClose && Gt(this.$el, "hide", vn(document, "click", function(t) {
                        var e = t.defaultPrevented,
                            i = t.target,
                            n = K(or);
                ...
                handler: function() {
                    var e = this;
                    or.splice(or.indexOf(this), 1), or.length || Ve(document.body, "overflowY", ""), or.some(function(t) {
    ...
    var hr = {
        install: function(t) {
            ...
            a.dialog = function(t, e) {
                ...
                return i.show(), Ut(i.$el, "hidden", function() {
                    return se.resolve().then(function() {
                        return i.$destroy(!0)
                    })
                }, {
    ...
    var fr = {
        ...
        gr = {
            ...
            methods: {
                scrollTo: function(t) {
                    var e = this;
                    t = t && Ce(t) || document.body, Kt(this.$el, "beforescroll", [this, t]) && Oi(t, this.$props).then(function() {
            ...
            update: [{
                read: function(t) {
                    ...
                    t.update && this.elements.forEach(function(t) {
                        ...
                        }).show = Pi(t, i.offsetTop, i.offsetLeft), t._ukScrollspyState = e
                    })
                },
                write: function(n) {
                    var r = this;
        ...
        wr = {
            ...
            computed: {
                ...
                isActive: {
                    ...
                    set: function(t) {
                        t && !this.isActive ? (Be(this.selTarget, this.clsInactive, this.clsActive), Kt(this.$el, "active")) : t || Oe(this.selTarget, this.clsInactive) || (Be(this.selTarget, this.clsActive, this.clsInactive), Kt(this.$el, "inactive"))
                    }
                }
            },
            connected: function() {
                this.placeholder = Ce("+ .uk-sticky-placeholder", this.$el) || Ce('<div class="uk-sticky-placeholder"></div>'), this.isFixed = !1, this.isActive = !1
            },
            disconnected: function() {
            ...
            update: [{
                ...
                write: function(t) {
                    ...
                    Ve(n, G({
                        height: e
                    }, i)), Yt(n, document) || (xe(this.$el, n), ot(n, "hidden", "")), this.isActive = this.isActive
                },
                events: ["resize"]
            }, {
                read: function(t) {
                    var e = t.scroll;
                    return void 0 === e && (e = 0), this.width = (Wt(this.widthElement) ? this.widthElement : this.$el).offsetWidth, this.scroll = window.pageYOffset, {
    ...
    function br(t, e) {
        var i = e.$props,
            ...
            r = e[t + "Offset"],
            o = i[t];
        if (o) return B(o) && D(o) && o.match(/^-?\d/) ? r + wi(o) : si(!0 === o ? n.parentNode : xt(o, n)).bottom
    }
    var xr = {
            mixins: [un],
            args: "connect",
            ...
            events: [{
                ...
                handler: function(e) {
                    e.preventDefault(), this.show(Ot(this.$el).filter(function(t) {
            ...
            methods: {
                ...
                show: function(t) {
                    for (var e, i, n = this, r = this.children, o = r.length, s = this.index(), a = 0 <= s, h = "previous" === t ? -1 : 1, u = ge(t, r, s), c = 0; c < o; c++, u = (u + h + o) % o)
                        if (!Mt(this.toggles[u], ".uk-disabled *, .uk-disabled, [disabled]")) {
                            e = this.toggles[u], i = r[u];
                            break
                        } i && s !== u && (De(r, this.cls), ze(i, this.cls), ot(this.toggles, "aria-expanded", !1), ot(e, "aria-expanded", !0), this.connects.forEach(function(t) {
                        a ? n.toggleElement([t.children[s], t.children[u]]) : n.toggleNow(t.children[u])
                    }))
                }
            }
        },
        ...
        kr = {
            ...
            events: [{
                ...
                handler: function(t) {
                    var e;
                    (Dt(t.target, 'a[href="#"], a[href=""]') || (e = Dt(t.target, "a[href]")) && (this.cls && !Oe(this.target, this.cls.split(" ")[0]) || !Wt(this.target) || e.hash && Mt(this.target, e.hash))) && t.preventDefault(), this.toggle()
                }
            }],
            update: {
                read: function() {
        ...
        Er = {
            ...
            methods: {
                animate: function(t) {
                    ...
                    t(), Ze.cancel(this.target), r.forEach(Ze.cancel), _r(this.target), this.$update(this.target), xi.flush();
                    ...
                    return o = a.map(function(t, e) {
                        ...
                        return o[e] && Ve(t, o[e])
                    }), Ve(this.target, "height", e), Bi(window, i), se.all(r.map(function(t, e) {
                        ...
                        }), _r(n.target), n.$update(n.target), xi.flush()
                    }, et)
                }
            }
        };
    ...
    var Fr = {
        mixins: [{
            ...
            methods: {
                start: function() {
                    ...
                    var e = "touchmove" != gt ? Ut(document, gt, this.move, {
                        passive: !1
                    }) : et;
                    this.unbindMove = function() {
                        e(), t.unbindMove = null
                    }, Ut(window, "scroll", this.unbindMove), Ut(document, mt, this.end, !0), Ve(this.list, "userSelect", "none")
                },
                move: function(t) {
                    var e = this;
                    if (this.unbindMove) {
                    ...
                    if (Xt(window, "scroll", this.unbindMove), this.unbindMove && this.unbindMove(), Xt(document, mt, this.end, !0), this.dragging)
        ...
        methods: {
            show: function(t, e) {
                ...
                if (void 0 === e && (e = !1), !this.dragging && this.length) {
                    ...
                    if (n[e ? "unshift" : "push"](t), !e && 1 < n.length) 2 === n.length && this._transitioner.forward(Math.min(this.duration, 200));
                        ...
                        if (a !== u) {
                            var c, l;
                            if (this.dir = (l = s, "next" === (c = t) ? 1 : "previous" === c || c < l ? -1 : 1), this.prevIndex = s, this.index = h, a && Kt(a, "beforeitemhide", [this]), !Kt(u, "beforeitemshow", [this, a])) return this.index = this.prevIndex, void o();
            ...
            _getTransitioner: function(t, e, i, n) {
                return void 0 === t && (t = this.prevIndex), void 0 === e && (e = this.index), void 0 === i && (i = this.dir || 1), void 0 === n && (n = this.transitionOptions), new this.Transitioner(P(t) ? this.slides[t] : t, P(e) ? this.slides[e] : e, i * (ct ? -1 : 1), n)
            }
        }
    };
    ...
    var Wr = {
        ...
        Vr = {
            ...
            events: [{
                ...
                name: "beforeitemshow",
                handler: function(t) {
                    this.isToggled() || (this.draggable = !1, t.preventDefault(), this.toggleNow(this.$el, !0), this.animation = Hr.scale, De(t.target, this.clsActive), this.stack.splice(1, 0, this.index))
                }
            }, {
                name: "itemshow",
                handler: function(t) {
    ...
    var qr, Yr = {
        ...
        methods: {
            show: function(t) {
                var e = this,
                    i = Q(this.toggles.map(Ur), "source");
                if (N(t)) {
                    var n = Ur(t).source;
                    t = y(i, function(t) {
                        var e = t.source;
    ...
    var Xr = {
        ...
        created: function() {
            var t = Ce("." + this.clsContainer + "-" + this.pos, this.$container) || we(this.$container, '<div class="' + this.clsContainer + " " + this.clsContainer + "-" + this.pos + '" style="display: block"></div>');
                ...
                props: function(g, m) {
                    ...
                    return Gr.reduce(function(t, e) {
                        ...
                        var i, n, r, o = e.match(/color/i),
                            s = o || "opacity" === e,
                            a = g[e].slice(0);
                        s && Ve(m, e, ""), a.length < 2 && a.unshift(("scale" === e ? 1 : s ? Ve(m, e) : 0) || 0);
                        ...
                        if (o) {
                            var u = m.style.color;
                            a = a.map(function(t) {
                                return Ve(Ve(m, "color", t), "color").split(/[(),]/g).slice(1, -1).concat(1).slice(0, 4).map(j)
                            }), m.style.color = u
                        } else if (w(e, "bg")) {
                            var c = "bgy" === e ? "height" : "width";
                            if (a = a.map(function(t) {
                                    return wi(t, c, v.$el)
                                }), Ve(m, "background-position-" + e[2], ""), n = Ve(m, "backgroundPosition").split(" ")["x" === e[2] ? 0 : 1], v.covers) {
                        ...
                        if ("stroke" === e) {
                            ...
                            var p = Pn(v.$el);
                            Ve(m, "strokeDasharray", p), "%" === h && (a = a.map(function(t) {
                                return t * p / 100
                ...
                Transitioner: function(r, n, o, t) {
                    ...
                    return {
                        ...
                        translate: function(t) {
                            ...
                            Ve(a, "transform", Br(tt(e - e * t - u, -io(a), si(a).width) * (ct ? -1 : 1), "px")), this.updateTranslates(), r && (t = tt(t, -1, 1), ro(this.getItemIn(), "itemtranslatein", {
                                percent: t,
                                dir: o
        ...
        go = {
            ...
            created: function() {
                ...
                ["init", "start", "move", "end"].forEach(function(t) {
                    var e = i[t];
                    i[t] = function(t) {
                        i.scrollY = window.pageYOffset, G(i.pos, re(t, "page")), e(t)
                    }
                })
            },
            events: {
            ...
            update: {
                write: function() {
                    if (this.clsEmpty && He(this.$el, this.clsEmpty, O(this.$el.children)), Ve(this.handle ? Ne(this.handle, this.$el) : this.$el.children, {
                            touchAction: "none",
                            userSelect: "none"
                        }), this.drag) {
                        var t = si(window),
            ...
            methods: {
                init: function(t) {
                    ...
                    !r || n || 0 < i || Rt(e) || Yt(e, "." + this.clsNoDrag) || this.handle && !Yt(e, this.handle) || (t.preventDefault(), this.touched = [this], this.placeholder = r, this.origin = G({
                        target: e,
                        index: pe(r)
                    }, this.pos), Ut(document, gt, this.move), Ut(document, mt, this.end), Ut(window, "scroll", this.scroll), this.threshold || this.start(t))
                },
                start: function(t) {
                    var e, i, n;
                    this.drag = (e = this.$container, i = this.placeholder, Ve(n = we(e, i.outerHTML.replace(/(^<)li|li(\/>$)/g, "$1div$2")), G({
                        boxSizing: "border-box",
                        width: i.offsetWidth,
                        height: i.offsetHeight,
                        overflow: "hidden"
                    }, Ve(i, ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"]))), ci(n.firstElementChild, ci(i.firstElementChild)), n);
                    var r, o = si(this.placeholder),
                        s = o.left,
                        a = o.top;
                    G(this.origin, {
                        left: s - this.pos.x,
                        top: a - this.pos.y
                    }), ze(this.drag, this.clsDrag, this.clsCustom), ze(this.placeholder, this.clsPlaceholder), ze(this.$el.children, this.clsItem), ze(document.documentElement, this.clsDragState), Kt(this.$el, "start", [this, this.placeholder]), r = this.pos, co = setInterval(function() {
                        var t = r.x,
                            a = r.y;
                ...
                move: function(t) {
                    ...
                    if (Xt(document, gt, this.move), Xt(document, mt, this.end), Xt(window, "scroll", this.scroll), this.drag) {
                        clearInterval(co);
                ...
                scroll: function() {
                    ...
                    t !== this.scrollY && (this.pos.y += t - this.scrollY, this.scrollY = t, this.$update())
                },
                insert: function(i, n) {
                    var r = this;
            ...
            methods: {
                show: function() {
                    ...
                    !this.isActive() && this.title && (mo.forEach(function(t) {
                        return t.hide()
                    }), mo.push(this), this._unbind = Ut(document, mt, function(t) {
                        return !Yt(t.target, e.$el) && e.hide()
                    }), clearTimeout(this.showTimer), this.showTimer = setTimeout(this._show, this.delay))
                },
                hide: function() {
                    this.isActive() && !Mt(this.$el, "input:focus") && (mo.splice(mo.indexOf(this), 1), clearTimeout(this.showTimer), clearInterval(this.hideTimer), ot(this.$el, "aria-expanded", !1), this.toggleElement(this.tooltip, !1), this.tooltip && ke(this.tooltip), this.tooltip = !1, this._unbind())
                },
                _show: function() {
                    var t = this;
                    this.tooltip = we(this.container, '<div class="' + this.clsPos + " " + this.cls + '" aria-expanded="true" aria-hidden> <div class="' + this.clsPos + '-inner">' + this.title + "</div> </div>"), this.positionAt(this.tooltip, this.$el), this.origin = "y" === this.getAxis() ? vi(this.dir) + "-" + this.align : this.align + "-" + vi(this.dir), this.toggleElement(this.tooltip, !0), this.hideTimer = setInterval(function() {
                        return !Wt(t.$el) && t.hide()
                    }, 150)
                },
                isActive: function() {
                    return b(mo, this)
                            ...
                            o = function(t) {
                                ...
                                le(n.url, {
                                    ...
                                    beforeSend: function(t) {
                                        var e = t.xhr;
                                        e.upload && Ut(e.upload, "progress", n.progress), ["loadStart", "load", "loadEnd", "abort"].forEach(function(t) {
    ...
    return J($r, So), J(Io, So), qi.use(function(r) {
        fe(function() {
            ...
            Ut(document, "animationstart", function(t) {
                ...
                if (i && i(), ne(t)) {
                    ...
                    i = Gt(document, mt + " " + bt, function(t) {
                        var e = re(t),
                            r = e.x,
                            o = e.y;
                    ...
                    }), "touchstart" == pt && (Ve(document.body, "cursor", "pointer"), Gt(document, mt + " " + bt, function() {
                        return setTimeout(function() {
        ...
        document.body && _e(document.body, ko);
        new MutationObserver(function(t) {
            var r = [];
            t.forEach(function(t) {
                return i = r, n = (e = t).target, void(("attributes" !== e.type ? function(t) {
                    for (var e = t.addedNodes, i = t.removedNodes, n = 0; n < e.length; n++) _e(e[n], ko);
                    for (var r = 0; r < i.length; r++) _e(i[r], $o);
                    return !0
                } : function(t) {
                    var e = t.target,
                        i = t.attributeName;
